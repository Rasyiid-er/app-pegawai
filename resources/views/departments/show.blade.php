...
@section('content')
    <h1 class="text-3xl font-semibold tracking-tight sm:text-3xl mb-3">Detail Departemen</h1>
        ...
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody class="bg-white">
                <tr class="bg-white dark:bg-gray-800">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">Nama Departemen</th>
                    <td class="px-6 py-4">{{ $department->nama_departemen }}</td>
                </tr>
            </tbody>
        </table>
    </div>
