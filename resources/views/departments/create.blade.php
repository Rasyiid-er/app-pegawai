...
@section('content')
    <h1 class="text-3xl font-semibold tracking-tight sm:text-3xl mb-3 text-center">Form Departemen</h1>
    ...
    <form action="{{ route('departments.store') }}" method="POST" class="max-w-2xl mx-auto">
        @csrf

        <div class="relative z-0 w-full mb-5 group">
            <input type="text" name="nama_departemen" id="nama_departemen" value="{{ old('nama_departemen') }}"
