...
@section('content')
    <h1 class="text-3xl font-semibold tracking-tight sm:text-3xl mb-3 text-center">Form Gaji</h1>
    ...
    <form action="{{ route('salaries.store') }}" method="POST" class="max-w-2xl mx-auto">
        @csrf
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="number" name="total_gaji" id="total_gaji" value="{{ old('total_gaji') }}"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required />
