...
@section('content')
    <div class="container mt-5">
        <h1 class="text-3xl font-semibold tracking-tight sm:text-3xl mb-3">Daftar Jabatan</h1>
        ...
        <div class="flex gap-3 mt-4">
            <form action="{{ route('positions.create') }}" method="GET">
                <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-6 py-2.5" type="submit">Tambah jabatan</button>
            </form>
