...
@section('content')
    <h1 class="text-3xl font-semibold tracking-tight sm:text-3xl mb-3 text-center">Form Jabatan</h1>
    ...
    <form action="{{ route('positions.store') }}" method="POST" class="max-w-2xl mx-auto">
        @csrf
